...
df = pd.read_csv('df_norm.csv',index_col="tempo", parse_dates=True)
...
df['vintequatrohoras'] = df.groupby(['lat_ocr', 'lon_ocr']).apply(lambda x: x[['vintequatrohoras']].interpolate(axis=0))
