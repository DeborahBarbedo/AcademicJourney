...
for i in range(len(janela_validacao_s)):
    ...
    model.add(Bidirectional(LSTM(33,activation='sigmoid', input_shape=(time_step, input_dim),return_sequences=True, kernel_regularizer=regularizers.L1L2(l1=1e-5, l2=1e-4)))) # camada escondida
...
df_saida_modelo.to_csv('Modelo8E1.csv')
