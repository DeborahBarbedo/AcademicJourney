...
for Cluster_n in range(1, 8):
    ...
    df = df_aux[df_aux['Cluster']==Cluster_n]
    ...
    ,'flg_ocupacao_desordenada'                         
            ...
            lista_variaveis = ['vintequatrohoras'         
,'Altitude_numerica'                     
,'lon_ocr'                  
,'lat_ocr'                  
,'Relevo_sombreado_numerico'
...
,'flg_cobertura_vegetal' ]
        ...
        nome_arquivo = f'Modelo6{experimento}_sig_6C_{Cluster_n}.csv'
        df_saida_modelo.to_csv(nome_arquivo, index=False)    
